...
//        String apiUrl = "http://localhost:8081/api/users"; // The API URL for fetching users
        String apiUrl = "http://localhost:8888/api/users"; // The API URL for fetching users
    ...
    public ModelAndView logout(HttpSession session) {
        ...
        return new ModelAndView("redirect:http://localhost:8888/");
