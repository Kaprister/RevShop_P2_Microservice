...
public class CorsConfig {
    ...
    public CorsWebFilter corsWebFilter() {
        ...
        corsConfig.addAllowedOrigin("http://localhost:5173");  // Allow specific origin // for react
        corsConfig.addAllowedOrigin("http://localhost:5174");  // Allow specific origin // for react
